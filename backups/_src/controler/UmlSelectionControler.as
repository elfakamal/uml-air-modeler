package controler
{
	...
	public class UmlSelectionControler extends EventDispatcher
	{
		...
		protected var _selectedOperations			:Array;
		...
		public function selectElement(element:IUmlViewElement):void
		{
			switch (true)
			{
				...
				break;
				case (element is UmlViewRegularNode) : 

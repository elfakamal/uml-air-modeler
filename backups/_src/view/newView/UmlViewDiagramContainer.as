package view.newView
{
	...
	public class UmlViewDiagramContainer extends Canvas
	{
		...
		public function addDiagram(diagram:UmlViewDiagram):void
		{
			...
			diagram.addEventListener(UmlEvent.NODE_SELECTED, onDiagramSelected);
		}
		...
		{
			if (e.getSelectedNode() is UmlViewDiagram)
			{
				var diagram:UmlViewDiagram = e.getSelectedNode() as UmlViewDiagram;

package view.newView
{
	...
	import view.core.UmlViewCoolElement;
...
//			_viewToolBar.addTool(new UmlViewToolItem("diagram", UmlModel.CLASS));
//			_viewToolBar.addTool(new UmlViewToolItem("diagram", UmlModel.INTERFACE));
//			_viewToolBar.addTool(new UmlViewToolItem("diagram", UmlModel.ATTRIBUTE));
//			_viewToolBar.addTool(new UmlViewToolItem("diagram", UmlModel.FUNCTION));
//			_viewToolBar.addTool(new UmlViewToolItem("diagram", UmlModel.ASSOCIATION));
//			_viewToolBar.addTool(new UmlViewToolItem("diagram", UmlModel.CONSTANT));
//			_viewToolBar.addTool(new UmlViewToolItem("diagram", UmlModel.PARAMETER));
			
			addChild(_viewToolBar);
			_viewToolBar.y = height;
		}

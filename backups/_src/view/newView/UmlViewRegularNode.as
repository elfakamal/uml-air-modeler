package view.newView
{
	 ...
	 * 
	 */
	public class UmlViewRegularNode extends UmlViewElement
	{
		...
		protected var _addInheritanceButton		:UmlViewPickerItem		= null;
		protected var _addUsageButton			:UmlViewPickerItem		= null;
		protected var _addDependencyButton		:UmlViewPickerItem		= null;
		protected var _addImplementationButton	:UmlViewPickerItem		= null;
		 ...
		 * 
		 */
		public function UmlViewRegularNode(modelElement:IUmlModelElement, parentUID:String)
		{
		...
		{
			_addFieldButton		= _nodeManagmentPicker.addTopLevelButton("+");
			_editFieldButton	= _nodeManagmentPicker.addTopLevelButton("..");
			_deleteFieldButton	= _nodeManagmentPicker.addTopLevelButton("-");
			...
			_addAssociationButton		= _nodeManagmentPicker.addLowLevelButton("");//"Association");
			_addInheritanceButton		= _nodeManagmentPicker.addLowLevelButton("");//"Inheritance");
			_addUsageButton				= _nodeManagmentPicker.addLowLevelButton("");//"Usage");
			_addDependencyButton		= _nodeManagmentPicker.addLowLevelButton("");//"Dependency");
			_addImplementationButton	= _nodeManagmentPicker.addLowLevelButton("");//"Implementation");
		...
		protected function onPickerItemMouseDown(e:MouseEvent):void
		{
			createAssociation();
		}
		 ...
		 */
		protected function createAssociation():void
		{
			// détécté par UmlViewDiagram
			var umlEvent:UmlEvent = new UmlEvent(UmlEvent.PICKER_ADD_ASSOCIATION);
		...
		protected override function createChildren():void
		{
			...
			if (_isTitleAllowed)
			{
				...
				_nodeManagmentPicker	= new UmlViewNodeManagmentPicker();
				...
				super.addChildAt(_nodeManagmentPicker, 0);
				createPickerButtons();
...
//			);
		...
		protected function deleteField(umlField:UmlViewField):void
		{
			...
			umlField.removeEventListener(UmlEvent.NODE_SELECTED, onFieldDeselected);

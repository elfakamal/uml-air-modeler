package controler
{
	...
	import controler.commands.UmlCommandSizePosition;
...
//			
		...
		protected function deleteNodes():void
		{
			...
			if (UmlSelectionControler.getInstance().getSelectedAttributes().length > 0 || 
			...
			else if (	UmlSelectionControler.getInstance().getSelectedClasses().length > 0 || 
			...
			else if (	UmlSelectionControler.getInstance().getSelectedDiagrams().length > 0 && 
						_isSelectedInTree)
			{
		...
		{
			var newClassEmpty:IUmlModelElement = null;
			...
			(
				UmlModel.getInstance().getSelectedProject().selectedNode,
				newClassEmpty
			);
		}
								...
								type			:String		= "int" ):void
		{
			if (UmlValidationControler.getInstance().isAttributeValid())
			{
				...
				var parent		:IUmlModelElement	= null;
				var umlConstant	:IUmlModelElement	= null;
				var typeUID		:String				= "";
				
				typeUID	= UmlModel.getInstance().getTypeUID(type);
				parent	= getNodeById(parentUID, UmlModel.getInstance().ownedElements);
				...
				if (parent != null)
				{
					...
					UmlModel.getInstance().addChildToElement(parent, umlConstant);
				}
				else
				{
					trace ("le parentUID est incorrect");
				}
			}
		}
							...
							type			:String		= "int" ):void
		{
			if (UmlValidationControler.getInstance().isAttributeValid())
			{
				...
				if (parent != null)
				{
					...
					UmlModel.getInstance().addChildToElement(parent, umlAttribute);
				}
			}
		}
								...
								parametersList		:Array		= null ):void
		{
			if (UmlValidationControler.getInstance().isOperationValid())
			{
				...
				if (parent != null)
				{
					...
					UmlModel.getInstance().addChildToElement(parent, umlOperation);
				}
			}
		}
								...
								value				:Object		= null):void
		{
			if (UmlValidationControler.getInstance().isEnumerationLiteralValid())
			{
				...
				if (parent != null)
				{
					...
					UmlModel.getInstance().addChildToElement(parent, umlEnumerationLiteral);
				}
			}
		}
		...
		{
			var parent		:IUmlModelElement = null;
			var umlSignal	:IUmlModelElement = null;
			...
			if (parent != null)
			{
				...
				UmlModel.getInstance().addChildToElement(parent, umlSignal);
			}
		}
								...
								type				:String		= ""):void
		{
			...
			if (parent != null)
			{
				...
				UmlModel.getInstance().addChildToElement(parent, umlSignalAttribute);
			}
		}
								...
								type				:String		= ""):void
		{
			if (UmlValidationControler.getInstance().isAttributeValid())
			{
				...
				if (parent != null)
				{
					...
					UmlModel.getInstance().addChildToElement(parent, umlParameter);
				}
			}
		}
								...
								multiplicity		:Array		= null):void
		{
			if (UmlValidationControler.getInstance().isAttributeValid())
			{
				...
				if (parent != null)
				{
					...
					UmlModel.getInstance().addChildToElement(parent, associationEnd);
				}
			}
		}
								...
								multiplicity		:Array		= null):void
		{
			...
			typeUID = UmlModel.getInstance().getTypeUID(typeName);

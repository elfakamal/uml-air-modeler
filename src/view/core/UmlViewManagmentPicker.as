package view.core
{
	 ...
	 * 
	 */
	public class UmlViewManagmentPicker extends UIComponent
	{
		 ...
		 * 
		 */
		protected var _relatedNode			:UmlViewClassifier	= null;
		 ...
		 * 
		 */
		public function UmlViewManagmentPicker()
		{
			super();
		...
		protected override function createChildren():void
		{
			...
			if (parent != null && parent is UmlViewClassifier)
			{
				_relatedNode = parent as UmlViewClassifier;
				initListeners();
			}
		}
		...
		protected function initListeners():void
		{
			...
			_relatedNode.addEventListener(UmlEvent.ELEMENT_SELECTED,		onRelatedNodeSelected);
			_relatedNode.addEventListener(UmlEvent.ELEMENT_DESELECTED,		onRelatedNodeDeselected);
		 ...
		 * 
		 */
		public function addTopLevelButton(	p_label	:String="", 
											iconUrl	:String="", 
											p_name	:String=""):UmlViewPickerItem
		{
			_numButtons++;
			var pickerItem:UmlViewPickerItem = null;
			pickerItem = new UmlViewPickerItem(p_label, iconUrl, p_name);
			_buttonsHolder.addChild(pickerItem);
			invalidateSize();
			return pickerItem;
		}
		
		public function addLowLevelButton(	p_label	:String, 
											iconUrl	:String="", 
											p_name	:String=""):UmlViewPickerItem
		{
			_numAssociations++;
			var pickerAssociationItem:UmlViewPickerItem = null;
			pickerAssociationItem = new UmlViewPickerItem(p_label, iconUrl, p_name);
